...
patient_info={'name':'John Doe', "height":1.37,'website':'https://www.abi.com','email':'ac@hdfc.com','age':'78', 'weight':70.5, 'married':False, 'allergies':['pollen', "nuts"], 'contact_detail':{'emergency':'12332532','email':'abhi@gmail.com'}}

patient1=Patient(**patient_info)

insert_patient_data(patient1)

patient_info={'name':'John Doe', "height":1.37,'website':'https://www.abi.com','email':'ac@icici.com', 'age':30, 'weight':86,  'allergies':['pollen', "nuts"],'contact_detail':{'email':'abhi@gmail.com'}}
